          ...
          <div class="h-100 p-5 text-bg-dark rounded-3">
            ...
            <form action="<?php print basename($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="number" name="ver_code" class="form-control form-control-lg" maxlength="6" min="10000" max="999999" id="ver_code" placeholder="Enter your verification code" <?php if(isset($_GET["tok"])){ print 'value="'.$_GET['tok'].'"'; }else{ print (isset($_SESSION["ver_code"])) ? 'value="'.$_SESSION["ver_code"].'"'  : ''; unset($_SESSION["ver_code"]); } ?> >
